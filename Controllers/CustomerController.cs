...
namespace FurrLife.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public CustomerController(ApplicationDbContext context, ILogger<CustomerController> logger, SignInManager<IdentityUser> signInManager, IPasswordHasher<IdentityUser> passwordHasher)
        {
            _context = context;
            _logger = logger;
        ...
        {
            var users = _context.Users.Where(m => m.SecurityStamp == UserRoles.Customer.Id).ToList();
            return View(users);
        }
