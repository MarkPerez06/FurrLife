...
namespace FurrLife.Controllers
{
    public class VeterinarianController : Controller
    {
        ...
        public VeterinarianController(ApplicationDbContext context, ILogger<VeterinarianController> logger, SignInManager<IdentityUser> signInManager, IPasswordHasher<IdentityUser> passwordHasher)
        {
            _context = context;
            _logger = logger;
